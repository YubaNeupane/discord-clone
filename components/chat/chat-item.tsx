      ...
      <div className="flex items-start w-full group gap-x-2">
        ...
        <div className="flex flex-col w-full">
          <div className="flex items-center gap-x-2">
            ...
            <span className="text-xs text-zinc-500 dark:text-zine-400">
              {timestamp}
            </span>
          </div>
          {isImage && (
                    ...
                    <FormItem className="flex-1">
                      <FormControl>
                        <div className="relative w-full">
                          <Input
                            disabled={isLoading}
                            className="p-2 border-0 bg-zinc-200/90 dark:bg-zinc-700/75 focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200"
